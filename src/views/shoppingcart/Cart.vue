  ...
  <div class="cart">
    ...
    <van-action-sheet v-model="cancelOrderShow">
      ...
      <van-radio-group v-model="reasonRadio">
        <van-cell-group>
          <van-cell title="收货地址填写错了" clickable @click="reasonRadio = '1'">
            <van-radio slot="right-icon" name="1" checked-color="#e02e24" />
          </van-cell>
          <van-cell title="忘记支付密码/余额不足" clickable @click="reasonRadio = '2'">
            <van-radio slot="right-icon" name="2" checked-color="#e02e24" />
          </van-cell>
          <van-cell title="无法正常支付" clickable @click="reasonRadio = '3'">
            <van-radio slot="right-icon" name="3" checked-color="#e02e24" />
          </van-cell>
          <van-cell title="不想买了" clickable @click="reasonRadio = '4'">
            <van-radio slot="right-icon" name="4" checked-color="#e02e24" />
          </van-cell>
          <van-cell title="其他原因" clickable @click="reasonRadio = '5'">
            <van-radio slot="right-icon" name="5" checked-color="#e02e24" />
          </van-cell>
        </van-cell-group>
      </van-radio-group>
      ...
      goodsData: [
        {
          ...
          desc: "30包【实惠装 240张/包】",
          thumb:
            "//t00img.yangkeduo.com/goods/images/2019-08-28/0d724d02-f524-4191-b27d-6d4f4d83236b.jpg?imageMogr2/sharpen/1%7CimageView2/2/w/234/q/70/format/webp",
          price: "19.9",
          num: "2"
        },
        {
